...
const imageGettingHandler = (event: any, setFileArray: any, setLocalArray: any) => {
...
const deleteFromImageListHandler = (index: number, setLocalArray: any, setImageArray: any) => {
        ...
        <section className={"house_posting"}>
            ...
            <div className={'images_posting'}>
                ...
                <div>
                    <div className={'file_input_part'}>
                        <label className={'file_input_label'}>
                            <input type="file" onChange={(e)=>imageGettingHandler(e,setOurImages,setLocalOurImages)} multiple={true} hidden/>
                    ...
                    <div className={'images_shower'}>
                        {localOurImages.map((element:string,index:number)=>{
                            return <div key={index+Math.random()} className={'littleImage'}>
                                <span onClick={()=>deleteFromImageListHandler(index,setLocalOurImages,setOurImages)}>X</span>
                                <img src={element} alt=""/>
                            </div>
                        })}
                    </div>
                ...
                <div>
                    <div className={'file_input_part'}>
                        <label className={'file_input_label'}>
                            <input type="file" onChange={(e)=>imageGettingHandler(e,setAllImages,setLocalAllImages)} multiple={true} hidden/>
                    ...
                    <div className={'images_shower'}>
                        {localAllImages.map((element:string,index:number)=>{
                            return <div key={index+Math.random()} className={'littleImage'}>
                                <span onClick={()=>deleteFromImageListHandler(index,setLocalAllImages,setAllImages)}>X</span>
                                <img src={element} alt=""/>
                            </div>
                        })}
                    </div>
                ...
                <div>
                    <div className={'file_input_part'}>
                        <label className={'file_input_label'}>
                            <input type="file" onChange={(e)=>imageGettingHandler(e,setVkayakanImages,setLocalVkayakanImages)} multiple={true} hidden/>
                    ...
                    <div className={'images_shower'}>
                        {localVkayakanImages.map((element:string,index:number)=>{
                            return <div key={index+Math.random()} className={'littleImage'}>
                                <span onClick={()=>deleteFromImageListHandler(index,setLocalVkayakanImages,setVkayakanImages)}>X</span>
                                <img src={element} alt=""/>
                            </div>
                        })}
                    </div>
